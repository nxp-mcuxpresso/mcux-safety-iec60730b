 ...
 *
 * @param dev Pointer to the ADC device structure used for measuring voltage to test the function of
 * ADC module.
 ...
 * @param channel Pointer to the ADC channel specification with parameters from user application or
 * board overlay.
 *
 * @return 0 on success, negative on failure
 */
