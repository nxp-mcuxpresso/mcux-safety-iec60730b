...
#if defined(CONFIG_IEC60730B_TEST_PC) &&                                                           \
	(defined(CONFIG_CPU_CORTEX_M0PLUS) || defined(CONFIG_CPU_CORTEX_M4) ||                     \
	 defined(CONFIG_CPU_CORTEX_M7) || defined(CONFIG_CPU_CORTEX_M33))
/*
