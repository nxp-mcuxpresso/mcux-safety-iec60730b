...
static int iec60730b_test_pc_cortex_verify_handler(void)
{
	__asm__ volatile(
		".syntax unified                    \n"
 ...
 */
__attribute__((naked, used))
static void iec60730b_test_pc_cortex_instruction_pattern(void)
{
	__asm__ volatile(
		".syntax unified                    \n"
		"MOV    R7, PC                      \n" /* copy PC into R7 */
 ...
 */
__attribute__((naked))
static int iec60730b_test_pc_cortex(uint32_t *flagAddr)
{
	__asm__ volatile(
		".syntax unified                    \n"
