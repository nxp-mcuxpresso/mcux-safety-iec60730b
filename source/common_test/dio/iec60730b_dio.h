...
typedef struct
{
    uint32_t mscr;  /* Multiplexed Signal Configuration Register */
    uint32_t gpdo;  /* SIUL2 GPIO Pad Data Output Register */
} fs_dio_backup_siul2_t;
...
typedef struct
{
    ...
    uint8_t pinNumGPDxN;
    uint8_t pinDir;
    fs_dio_backup_siul2_t sTestedPinBackup;
} fs_dio_test_siul2_t;
