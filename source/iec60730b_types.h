...
typedef struct {
  ...
  volatile uint32_t CNT;                               /**< Count, offset: 0x4 */
       uint8_t RESERVED_0[8];
  struct {                                         /* offset: 0x10, array step: 0x10 */
    volatile uint32_t CCR;                               /**< Channel Control, array offset: 0x10, array step: 0x10 */
    volatile uint32_t CIR;                               /**< Channel Interrupt, array offset: 0x14, array step: 0x10 */
    volatile uint32_t CMP;                               /**< Channel Compare, array offset: 0x18, array step: 0x10 */
...
typedef struct {
       uint8_t RESERVED_0[4];
  volatile const  uint32_t MIDR1;                             /**< SIUL2 MCU ID Register #1, offset: 0x4 */
  volatile const  uint32_t MIDR2;                             /**< SIUL2 MCU ID Register #2, offset: 0x8 */
       uint8_t RESERVED_1[4];
  volatile uint32_t DISR0;                             /**< SIUL2 DMA/Interrupt Status Flag Register0, offset: 0x10 */
       uint8_t RESERVED_2[4];
  volatile uint32_t DIRER0;                            /**< SIUL2 DMA/Interrupt Request Enable Register0, offset: 0x18 */
       uint8_t RESERVED_3[4];
  volatile uint32_t DIRSR0;                            /**< SIUL2 DMA/Interrupt Request Select Register0, offset: 0x20 */
       uint8_t RESERVED_4[4];
  volatile uint32_t IREER0;                            /**< SIUL2 Interrupt Rising-Edge Event Enable Register 0, offset: 0x28 */
       uint8_t RESERVED_5[4];
  volatile uint32_t IFEER0;                            /**< SIUL2 Interrupt Falling-Edge Event Enable Register 0, offset: 0x30 */
       uint8_t RESERVED_6[4];
  volatile uint32_t IFER0;                             /**< SIUL2 Interrupt Filter Enable Register 0, offset: 0x38 */
       uint8_t RESERVED_7[4];
  volatile uint32_t IFMCR[32];          /**< SIUL2 Interrupt Filter Maximum Counter Register, array offset: 0x40, array step: 0x4 */
  volatile uint32_t IFCPR;                             /**< SIUL2 Interrupt Filter Clock Prescaler Register, offset: 0xC0 */
       uint8_t RESERVED_8[316];
  volatile const  uint32_t MIDR3;                             /**< SIUL2 MCU ID Register #3, offset: 0x200 */
  volatile const  uint32_t MIDR4;                             /**< SIUL2 MCU ID Register #4, offset: 0x204 */
       uint8_t RESERVED_9[56];
  volatile uint32_t MSCR[220];            /**< SIUL2 Multiplexed Signal Configuration Register, array offset: 0x240, array step: 0x4, valid indices: [0-37, 40-219] */
       uint8_t RESERVED_10[1168];
  volatile uint32_t IMCR[379];            /**< SIUL2 Input Multiplexed Signal Configuration Register, array offset: 0xA40, array step: 0x4, valid indices: [0-5, 16-71, 80-103, 112-135, 144-149, 152-202, 211-268, 289-309, 315-325, 343-378] */
       uint8_t RESERVED_11[724];
  volatile uint8_t GPDO[220];             /**< SIUL2 GPIO Pad Data Output Register, array offset: 0x1300, array step: 0x1, valid indices: [0-35, 38-219] */
       uint8_t RESERVED_12[292];
  volatile const  uint8_t GPDI[220];             /**< SIUL2 GPIO Pad Data Input Register, array offset: 0x1500, array step: 0x1, valid indices: [0-35, 38-219] */
       uint8_t RESERVED_13[292];
  volatile uint16_t PGPDO[14];          /**< SIUL2 Parallel GPIO Pad Data Out Register, array offset: 0x1700, array step: 0x2 */
       uint8_t RESERVED_14[36];
  volatile const  uint16_t PGPDI[14];          /**< SIUL2 Parallel GPIO Pad Data In Register, array offset: 0x1740, array step: 0x2 */
       uint8_t RESERVED_15[36];
  volatile uint32_t MPGPDO[14];        /**< SIUL2 Masked Parallel GPIO Pad Data Out Register, array offset: 0x1780, array step: 0x4 */
} fs_siul2_t;
...
typedef struct {
  volatile uint32_t SC1A;                              /**< ADC Status and Control Register 1, offset: 0x0 */
  volatile uint32_t SC1B;                              /**< ADC Status and Control Register 1, offset: 0x4 */
  volatile uint32_t SC1C;                              /**< ADC Status and Control Register 1, offset: 0x8 */
  volatile uint32_t SC1D;                              /**< ADC Status and Control Register 1, offset: 0xC */
  volatile uint32_t SC1E;                              /**< ADC Status and Control Register 1, offset: 0x10 */
  volatile uint32_t SC1F;                              /**< ADC Status and Control Register 1, offset: 0x14 */
  volatile uint32_t SC1G;                              /**< ADC Status and Control Register 1, offset: 0x18 */
  volatile uint32_t SC1H;                              /**< ADC Status and Control Register 1, offset: 0x1C */
  volatile uint32_t SC1I;                              /**< ADC Status and Control Register 1, offset: 0x20 */
  volatile uint32_t SC1J;                              /**< ADC Status and Control Register 1, offset: 0x24 */
  volatile uint32_t SC1K;                              /**< ADC Status and Control Register 1, offset: 0x28 */
  volatile uint32_t SC1L;                              /**< ADC Status and Control Register 1, offset: 0x2C */
  volatile uint32_t SC1M;                              /**< ADC Status and Control Register 1, offset: 0x30 */
  volatile uint32_t SC1N;                              /**< ADC Status and Control Register 1, offset: 0x34 */
  volatile uint32_t SC1O;                              /**< ADC Status and Control Register 1, offset: 0x38 */
  volatile uint32_t SC1P;                              /**< ADC Status and Control Register 1, offset: 0x3C */
  ...
  volatile const uint32_t RA;                          /**< ADC Data Result Registers, offset: 0x48 */
  volatile const uint32_t RB;                          /**< ADC Data Result Registers, offset: 0x4C */
  volatile const uint32_t RC;                          /**< ADC Data Result Registers, offset: 0x50 */
  volatile const uint32_t RD;                          /**< ADC Data Result Registers, offset: 0x54 */
  volatile const uint32_t RE;                          /**< ADC Data Result Registers, offset: 0x58 */
  volatile const uint32_t RF;                          /**< ADC Data Result Registers, offset: 0x5C */
  volatile const uint32_t RG;                          /**< ADC Data Result Registers, offset: 0x60 */
  volatile const uint32_t RH;                          /**< ADC Data Result Registers, offset: 0x64 */
  volatile const uint32_t RI;                          /**< ADC Data Result Registers, offset: 0x68 */
  volatile const uint32_t RJ;                          /**< ADC Data Result Registers, offset: 0x6C */
  volatile const uint32_t RK;                          /**< ADC Data Result Registers, offset: 0x70 */
  ...
  volatile uint32_t GAIN;                              /**< ADC Gain Register, offset: 0xAC */
  ...
  volatile uint32_t SC1[32];                /**< ADC Status and Control Register 1, array offset: 0x108, array step: 0x4 */
  volatile const uint32_t R[32];              /**< ADC Data Result Registers, array offset: 0x188, array step: 0x4 */
} fs_aio_a8_t;
...
#define FS_FLASH_CRC_CTRL_TCRC_MASK 0x1000000U
